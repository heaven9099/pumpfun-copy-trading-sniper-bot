...
export const LOSS_DURARTION = Number(retrieveEnvVariable('LOSS_DURARTION', logger))
export const PROFIT_DURATION = Number(retrieveEnvVariable('PROFIT_DURATION', logger))
